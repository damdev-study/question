...
public class ApiController {
  ...
  public JSONObject document(HttpServletRequest request, HttpServletResponse response, @PathVariable String category,
    @PathVariable String docid) {
    return apiService.document(request, response, category, docid);
  }

  @GetMapping("/image/feature")
  public JSONObject featureExtraction(HttpServletRequest request, HttpServletResponse response,
  ...
  @DeleteMapping(value = "/image/feature", produces = "application/json")
  public JSONObject featureDelete(HttpServletRequest request, HttpServletResponse response,
    @RequestBody DeleteList data) {
    return apiService.deleteFeature(request, response, data);
  }
